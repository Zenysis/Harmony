/* eslint-disable */
// NOTE: Full copy of eslint-plugin-import's import/order rule with
...
function attachInnerGroupOrder(imported) {
  ...
  imported.forEach(importedModule => {
    ...
    if (
      ...
      // NOTE: Store the imported value name so we can use it during
      // error reporting.
...
function computeRank(context, ranks, name, type) {
  // $ZenysisModified
  // NOTE: `util` is detected as a vendor type despite it being an
