...
class SingleFieldValidationRow(FieldValidationRow):
    ...
    # TODO: Are dimension columns needed or can they be derived?
    def __init__(
        ...
        # NOTE: Currently only support single value validation
        granularity = 'all'
    ...
    def validate_result(self, pydruid_result):
        ...
        result_event = result[0]['event'] if result else {}
...
class DruidEventValidationRow(FieldValidationRow):
    ...
    def __init__(self, event_row, query_client=None, compute_field_calculation=None):
        ...
        # NOTE: Currently only support single date period validation
        granularity = 'all'
    ...
    def get_result_field(cls, field_id):
        return f'{cls.RESULT_FIELD_PREFIX}{field_id}'
    ...
    def parse_event(cls, raw_event):
        ...
        for key, value in event.items():
            if isinstance(value, str):
                ...
                assert False, f'Invalid value type. Must be string or float: {value}'
