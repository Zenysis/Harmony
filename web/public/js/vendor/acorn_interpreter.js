// NOTE(stephen): We prefer non-minified vendor files in dev to ease debugging.
...
// NOTE(stephen): Acorn must come first, since it is a dependency of Interpreter
// NOTE(stephen): To stay in sync with the minified file, make sure you use the
