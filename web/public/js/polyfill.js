...
(function polyfill() {
  ...
  // NOTE: The reference implementation has been modified to use
  // Set.forEach instead of `for .. of` in case the Set object itself was
  // polyfilled into an older browser.
  // NOTE: The reference implementation was also modified to not
  ...
  // NOTE: We actually accept any array-like object that has a
