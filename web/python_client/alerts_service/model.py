...
@related.immutable
class AlertDefinitionMeta:
    '''Object representation of the metadata for an Alert Definition.'''

    # NOTE: Maybe we want to convert this to user?
...
class AlertDefinition(AlertDefinitionMeta):
    ...
    # TODO: Perhaps this should have the basic _uri be part of this.
...
class AlertNotificationMeta:
    ...
    # TODO: Possible to change constructor to take in just a string
