...
def calculate_totals(
    line_graph_viz: LineGraphVisualization, original_df: pd.DataFrame
) -> dict:
    ...
    request = line_graph_viz.request.copy(groups=groups)
    ...
    # NOTE: Remove any invalid keys. This in theory should not be possible but
