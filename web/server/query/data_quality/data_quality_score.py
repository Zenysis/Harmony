...
# NOTE: These add up to 11 as Completness trend is a score between 0 and -1.
...
def calc_raw_completeness_trend_score(slope: float, report_counts: List[int]) -> float:
    ...
    # NOTE: This score is only included if the slope is negative. This is
...
# NOTE: first_report_date differs from the earliest date in
