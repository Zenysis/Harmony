...
class DataCatalogPageRouter:
    ...
    # TODO: tighten the security here
    @authentication_required(force_authentication=True)
    @authorization_required('can_view_data_catalog', 'site')
    ...
    def data_catalog_field(self, field_id_path, locale=None):
        ...
        # NOTE: Experimenting with pretty SEO-style URLs for the field
        ...
        # NOTE: Disabling field ID validation for now while we work through
