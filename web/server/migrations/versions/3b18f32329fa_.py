...
def upgrade():
    op.create_table(
        ...
        sa.Column(
            'reset_password_token', sa.String(100), nullable=False, server_default=''
        ),
    ...
    op.create_table(
        ...
        sa.Column('id', sa.INTEGER, primary_key=True),
        sa.Column(
            'name', sa.String(50), nullable=False, server_default='', unique=True
        ),
        sa.Column('label', sa.Unicode(255), server_default=''),
    )
