...
export type dimension_update_column = "description" | "id" | "name" | "%future added value";
...
|};
export type usePublishFieldMutationVariables = {|
  id: string,
  name: string,
  shortName: string,
  description: string,
...
|};
export type usePublishFieldMutationResponse = {|
  +insert_field: ?{|
  ...
  |},
|};
export type usePublishFieldMutation = {|
  variables: usePublishFieldMutationVariables,
  response: usePublishFieldMutationResponse,
|};
*/


/*
mutation usePublishFieldMutation(
  $id: String!
  $name: String!
  $shortName: String!
  $description: String!
...
return {
  ...
  "params": {
    "cacheID": "66ebe99ff2d0e14cba8ba19ca7e285bc",
    "id": null,
    "metadata": {},
    "name": "usePublishFieldMutation",
    "operationKind": "mutation",
    "text": "mutation usePublishFieldMutation(\n  $id: String!\n  $name: String!\n  $shortName: String!\n  $description: String!\n  $calculation: jsonb!\n  $fieldCategoryMappings: [field_category_mapping_insert_input!]!\n  $fieldPipelineDatasourceMappings: [field_pipeline_datasource_mapping_insert_input!]!\n) {\n  insert_field(objects: {id: $id, name: $name, short_name: $shortName, description: $description, calculation: $calculation, field_category_mappings: {data: $fieldCategoryMappings}, field_pipeline_datasource_mappings: {data: $fieldPipelineDatasourceMappings}}) {\n    returning {\n      id\n      name\n      short_name\n      description\n      calculation\n      field_category_mappings {\n        id\n      }\n      field_pipeline_datasource_mappings {\n        id\n      }\n    }\n  }\n  delete_unpublished_field_by_pk(id: $id) {\n    id\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'cf98783de93d6b96c4972b9a9cc98990';
