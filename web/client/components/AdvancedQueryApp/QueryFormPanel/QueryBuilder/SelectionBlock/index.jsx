...
> extends React.PureComponent<Props<T>, State<T>> {
  ...
  onItemCustomized(item: T) {
    ...
    // NOTE: I think this would happen only during some type of race
    ...
    // NOTE: There is a potentially really annoying issue lurking here
  ...
  renderTitle(): React.Element<'div'> | void {
    ...
    return (
      <div className="selection-block" data-testid={this.props.testId}>
        ...
        {this.props.orientation === 'horizontal' ? (
          <div className="selection-block__horizontal">
