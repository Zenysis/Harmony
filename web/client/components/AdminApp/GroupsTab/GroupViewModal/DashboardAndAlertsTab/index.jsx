...
const ALERT_HEADERS = [
  ...
  {
    displayContent: I18N.textById('Duration'),
    id: 'duration',
...
export default function DashboardAndAlertsTab({
  ...
  const alertSection = (
    <Group.Vertical spacing="m">
      ...
      >
        <Heading size={Heading.Sizes.SMALL}>{I18N.textById('Alerts')}</Heading>
        <button
          className="group-view-modal__add-button"
          onClick={onAddAlertClick}
          type="button"
        >
          {I18N.textById('+ Add Alerts')}
        </button>
      </Group.Horizontal>
      <div className="group-view-modal__header" />
      <Table
