...
const translations: TranslationDictionary = {
  ...
  br: {
    ...
    dashboardViewer: 'Visualizador de Painel',
    dataAccessDescription:
      'Selecione os dados a que esta fun\xE7\xE3o ir\xE1 conceder acesso, quando atribu\xEDda a um utilizador ou grupo.',
    dataExportDisclaimer:
      'Observa\xE7\xE3o: os usu\xE1rios com permiss\xF5es para essa fun\xE7\xE3o tamb\xE9m podem obter acesso \xE0 exporta\xE7\xE3o de dados por meio de outra fun\xE7\xE3o.',
    datasourceCount: {
      one: '%(count)s fontes de dados',
      other: '1 fonte de dados',
      zero: 'Nenhuma fonte de dados',
    },
    dimensionCount: {
      one: '%(count)s %(dimensionName)ss',
      other: '1 %(dimensionName)s',
      zero: 'Sem %(dimensionName)ss',
    },
    firstName: 'Primeiro Nome',
    geographyCount: {
      one: '%(count)s geografias',
      other: '1 geografia',
      zero: 'Nenhuma geografia',
    },
    inactive: 'Inativo',
    lastName: '\xDAltimo nome',
    nameDescription:
      'O nome da fun\xE7\xE3o \xE9 exibida ao selecionar fun\xE7\xF5es a serem atribu\xEDdas a usu\xE1rios ou grupos e ser\xE1 exibido al\xE9m de nomes de utilizadores e grupos durante toda a plataforma.',
    noRoleName:
      'N\xE3o \xE9 poss\xEDvel adicionar ou actualizar uma fun\xE7\xE3o sem nome.',
    pending: 'Pendente',
    siteAdminTitleTooltip:
      'Esta fun\xE7\xE3o n\xE3o pode ser modificada ou exclu\xEDda',
    sitewideDescription:
      'Por padr\xE3o, os usu\xE1rios precisam ser convidados para aceder a pain\xE9is ou alertas individuais. As configura\xE7\xF5es abaixo permitem que esta Fun\xE7\xE3o passe a garantir acesso a todos os pain\xE9is ou alertas na plataforma, quando atribu\xEDdo a um utilizador ou grupo.',
    toolsDescription:
      'Escolha quais as ferramentas a que esta fun\xE7\xE3o ir\xE1 conceder acesso, quando atribu\xEDdo a um utilizador ou grupo.',
    userRoles: 'Fun\xE7\xF5es do usu\xE1rio',
    'All %(dimensionName)ss': 'Todos %(dimensionName)ss',
    'All Users': 'Todos usu\xE1rios',
    'All data sources': 'Todas as fontes de dados',
    'All geographies': 'Todas as geografias',
    'Allow access to all %(dimensionText)s':
      'Permitir o acesso a todos os %(dimensionText)s',
    ...
    'Enter email': 'Escreva o email',
    'Enter name': 'Escreva o nome',
    'Entity matching': 'Correspond\xEAncia entre entidades',
    'Force Delete': 'Apagar',
    'Hide advanced options': 'Ocultar op\xE7\xF5es avan\xE7adas',
    'Invite User': 'Convidar usu\xE1rios',
    'Phone Number': 'N\xFAmero de telefone',
    'Role Management': 'Administra\xE7\xE3o de Fun\xE7\xF5es',
    'Select %(dimensionText)s': 'Selecione %(dimensionText)s',
    'Select specific %(dimensionText)s':
