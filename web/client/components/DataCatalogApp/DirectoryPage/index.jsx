...
export default function DirectoryPage(): React.Node {
  ...
  // NOTE: This is a rudimentary implementation of single-page-app
  ...
  // TODO: I (Stephen) have not actually verified all
  ...
  // TODO: Figure out what to do when an invalid category
