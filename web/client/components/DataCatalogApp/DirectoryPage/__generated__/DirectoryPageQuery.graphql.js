...
export type DirectoryPageQueryVariables = {||};
export type DirectoryPageQueryResponse = {|
  +categoryConnection: {|
  ...
  |},
|};
export type DirectoryPageQuery = {|
  variables: DirectoryPageQueryVariables,
  response: DirectoryPageQueryResponse,
|};
*/
...
return {
  ...
  "params": {
    "cacheID": "eb44bcbe6e0fad6e72bcccb80ad3158f",
    "id": null,
    "metadata": {},
    "name": "DirectoryPageQuery",
    "operationKind": "query",
    "text": "query DirectoryPageQuery {\n  categoryConnection: category_connection {\n    ...useFilterHierarchy_categoryConnection\n  }\n  fieldConnection: field_connection {\n    ...useFilterHierarchy_fieldConnection\n  }\n}\n\nfragment useFilterHierarchy_categoryConnection on categoryConnection {\n  edges {\n    node {\n      id\n      name\n      parent {\n        id\n      }\n    }\n  }\n}\n\nfragment useFilterHierarchy_fieldConnection on fieldConnection {\n  edges {\n    node {\n      id\n      name\n      shortName: short_name\n      fieldCategoryMappings: field_category_mappings {\n        category {\n          id\n        }\n        id\n      }\n    }\n  }\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'b0b0f9eb3a0fc8fdfd6ac7df3b60e62d';
