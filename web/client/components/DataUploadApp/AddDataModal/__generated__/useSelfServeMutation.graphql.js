...
export type useSelfServeMutationResponse = {|
  ...
  |},
|};
export type useSelfServeMutation = {|
  variables: useSelfServeMutationVariables,
  response: useSelfServeMutationResponse,
|};
*/
...
mutation useSelfServeMutation(
  ...
  update_data_upload_file_summary(where: {id: {_in: $fileSummariesToUnlink}}, _set: {self_serve_source_id: null}) {
    returning {
      id
    }
  }
  insert_self_serve_source(objects: [$selfServeSource]) @include(if: $insertNewSource) {
    returning {
      ...useSelfServeMutation_DataUploadTableFragment
      id
    }
  }
  insert_self_serve_source(objects: [$selfServeSource], on_conflict: {constraint: self_serve_source_pkey, update_columns: last_modified}) @skip(if: $insertNewSource) {
    returning {
      ...useSelfServeMutation_DataUploadTableFragment
      id
    }
...
var v0 = [
  {
    "defaultValue": null,
    "kind": "LocalArgument",
    "name": "fileSummariesToUnlink"
  },
  {
    "defaultValue": null,
    "kind": "LocalArgument",
    "name": "insertNewSource"
  },
  {
    "defaultValue": null,
    "kind": "LocalArgument",
    "name": "selfServeSource"
  }
],
v1 = {
  "alias": null,
...
v2 = {
          ...
          "fields": [
            {
              "kind": "Variable",
              "name": "_in",
              "variableName": "fileSummariesToUnlink"
            }
          ],
          "kind": "ObjectValue",
          "name": "id"
  ...
  "kind": "LinkedField",
  "name": "update_data_upload_file_summary",
  "plural": false,
  "selections": [
    {
      "alias": null,
...
return {
  "fragment": {
    ...
    "kind": "Fragment",
    "metadata": null,
    "name": "useSelfServeMutation",
    "selections": [
      (v2/*: any*/),
      {
        "condition": "insertNewSource",
        "kind": "Condition",
        "passingValue": true,
        "selections": [
          {
            "alias": null,
            "args": (v4/*: any*/),
            "concreteType": "self_serve_source_mutation_response",
            "kind": "LinkedField",
            "name": "insert_self_serve_source",
            "plural": false,
            "selections": (v5/*: any*/),
            "storageKey": null
          }
  ...
  "params": {
    "cacheID": "56e3da866625f91d4b73e62e90aa1759",
    "id": null,
    "metadata": {},
    "name": "useSelfServeMutation",
    "operationKind": "mutation",
    "text": "mutation useSelfServeMutation(\n  $fileSummariesToUnlink: [Int!]!\n  $insertNewSource: Boolean!\n  $selfServeSource: self_serve_source_insert_input!\n) {\n  update_data_upload_file_summary(where: {id: {_in: $fileSummariesToUnlink}}, _set: {self_serve_source_id: null}) {\n    returning {\n      id\n    }\n  }\n  insert_self_serve_source(objects: [$selfServeSource]) @include(if: $insertNewSource) {\n    returning {\n      ...useSelfServeMutation_DataUploadTableFragment\n      id\n    }\n  }\n  insert_self_serve_source(objects: [$selfServeSource], on_conflict: {constraint: self_serve_source_pkey, update_columns: last_modified}) @skip(if: $insertNewSource) {\n    returning {\n      ...useSelfServeMutation_DataUploadTableFragment\n      id\n    }\n  }\n}\n\nfragment ActionCell_selfServeSource on self_serve_source {\n  id\n  sourceId: source_id\n  pipelineDatasource: pipeline_datasource {\n    name\n    id\n  }\n  latestFileSummary: data_upload_file_summaries(order_by: {last_modified: desc}, limit: 1) {\n    lastModified: last_modified\n    id\n  }\n  sourceLastModified: last_modified\n  dataUploadFileSummaries: data_upload_file_summaries {\n    id\n    filePath: file_path\n    userFileName: user_file_name\n    columnMapping: column_mapping\n    lastModified: last_modified\n  }\n  dataprepFlow: dataprep_flow {\n    id\n    appendable\n    expectedColumns: expected_columns\n    dataprepJobs: dataprep_jobs(limit: 1, order_by: {created: desc}) {\n      jobId: job_id\n      status\n      id\n    }\n    recipeId: recipe_id\n  }\n}\n\nfragment useSelfServeMutation_DataUploadTableFragment on self_serve_source {\n  pipelineDatasource: pipeline_datasource {\n    id\n    unpublishedFieldsCount: unpublished_field_pipeline_datasource_mappings_aggregate {\n      aggregate {\n        count\n      }\n    }\n  }\n  dataprepFlow: dataprep_flow {\n    dataprepJobs: dataprep_jobs(limit: 1, order_by: {created: desc}) {\n      lastModifiedOnDataprep: last_modified_on_dataprep\n      id\n    }\n    id\n  }\n  lastModified: last_modified\n  ...ActionCell_selfServeSource\n}\n"
  }
};
})();
// prettier-ignore
(node/*: any*/).hash = 'ee3c5cd1f9bacb569114e0fea47454e1';
