...
function LegendItemRow({ item, onClick, onDoubleClick }: Props) {
  ...
  // NOTE: Handling double clicks is kind of a pain. If there is both a
  ...
  // NOTE: If the label text is cutoff with elipses we display a tooltip
  // with the full label.
  ...
  const legendItemContents = (
    ...
    >
      ...
      <div ref={labelRef} className="line-graph-legend-item-row__label">
        {label}
      </div>
    </div>
  );
