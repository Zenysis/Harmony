...
export default class Histogram extends React.PureComponent<Props, State> {
  ...
  // TODO: Add support for y2Axis. It should just work by
  ...
  // contain values for.
  // NOTE: The `metrics` array will contain all metrics including those
  ...
  buildDimensionValueFormatter(
    ...
    return (dimensionId, value) => {
      // NOTE: The Histogram viz only ever has a single x-axis level
      ...
      // NOTE: When using a date extraction (rather than date
      // group), the year returned in the date is 3000. Do not apply the custom
      // date format when this happens.
      // TODO: Remove once grouping settings are exposed to the
  ...
  // NOTE: This is a temporary hack to throw a legend in. Kind of
