...
// Enabled locales are used in String.prototype.localeCompare()
...
function buildDimensionBreakdown(
  ...
  // Alphabetically sort the children so that the order is deterministic.
  const childOrder = Array.from(uniqueChildren).sort((a, b) => {
