...
class BubbleChart extends React.PureComponent<Props, State> {
  ...
  // TODO: Add a new control so the user can choose wich field
  ...
  maybeRenderReturnError() {
    ...
    return (
      <span>
        <h3>
          <I18N id="bubbleChartErrorMessage">
  ...
  maybeRenderLegend() {
    ...
    // TODO: I do not know why the logic is this way and I do not know
  ...
  render() {
    return (
      <Visualization loading={this.props.loading}>
        <div ref={this.resizeRegistration.setRef} className="bubblechart-viz">
