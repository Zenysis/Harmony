...
function MarkerLayer({
  ...
  const circleLayer = React.useMemo<LayerStyle>(() => {
    // TODO: Handle case where we are trying to scale up the radius
    ...
    //
    // NOTE: This applies the same scaling formula that was used on
    // the previous Map viz implementation. Review if this is accurate.
    //
    // NOTE: Added scale factor that incorporates the "default" radius
