...
function PopupContainer({
  ...
  // NOTE: This will not change whether the feature being displayed
  ...
  return (
    <Popover
      ...
      // To avoid playing a game of "who's got the highest z-index", we can
      // just unset the z-index and trust that it will be thrown to the top.
      zIndex={undefined}
    >
