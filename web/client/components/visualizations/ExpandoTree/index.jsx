...
// NOTE: Many D3 operations here modify the nodes in place. This is
...
class ExpandoTree extends React.PureComponent<Props, State> {
  ...
  // NOTE: D3 mutates objects. To ensure we do not taint the original
  ...
  getNodeDisplayValue({ depth, metrics }: D3HierarchyNode): string | void {
    ...
    // NOTE: This is a simple way to handle results that have a time
  ...
  update(source: D3HierarchyNode | void) {
    ...
    // NOTE: Directly set the height of the SVG so that scrolling can
  ...
  // TODO: This visualization needs to be rebuilt.
  @autobind
  renderVisualization(height: number): React.Node {
    return (
      ...
      >
        <svg ref={this._treeRef} className="expando-tree__chart">
