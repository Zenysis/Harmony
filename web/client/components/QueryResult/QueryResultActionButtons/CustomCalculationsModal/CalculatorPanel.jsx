...
import type { ButtonClickHandler } from 'components/ui/LegacyButton';

type Props = {
  onSymbolClick: ButtonClickHandler,
};

const ButtonTypes: { [string]: string } = {
  plus: '+',
  minus: '-',
  multiply: '*',
  divide: '/',
...
const SymbolSVGPaths: { [string]: Array<string> } = {
