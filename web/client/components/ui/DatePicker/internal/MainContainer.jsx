...
const MODIFIERS_TEXT = {
  ALL_TIME: I18N.text('Between'),
  BETWEEN: I18N.textById('Between'),
  LAST: I18N.text('Last'),
  SINCE: I18N.text('Since'),
  THIS: I18N.text('This'),
  YEAR_TO_DATE: I18N.textById('Between'),
};
...
export default function MainContainer({
  ...
  return (
    <div className="zen-date-picker__main-container">
      <Heading.Small>{I18N.text('Your date selection')}</Heading.Small>
      <Dropdown
