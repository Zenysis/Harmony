...
export default function RangeGregorianCalendarEditor({
  ...
  const onInputBlur = React.useCallback(event => {
    ...
    if (
      ...
      // NOTE: this is dangerous but is the only way we have to detect
    ...
    <>
      <div className="zen-calendar-editor__input-row">
        <CalendarDateInput
          ...
          date={fromDateInput}
          invalidMessage={I18N.text('Please enter a valid start date')}
        ...
        <CalendarDateInput
          ...
          date={toDateInput}
          invalidMessage={I18N.text('Please enter a valid end date')}
      ...
      >
        <ZenDayPicker
          ...
          modifiers={{ end: to || hoveredDate, start: from }}
          month={calendarMonth}
          numberOfMonths={2}
