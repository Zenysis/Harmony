...
// NOTE: Using our own style object instead of StyleObject because we
...
> {
  ...
  renderItems(): React.Node {
    ...
    // NOTE: Iterating imperatively since we need to reorder the items
    ...
    for (let i = 0; i < items.size(); i++) {
      ...
      // NOTE: Intentionally using the index as the key here. Since we
