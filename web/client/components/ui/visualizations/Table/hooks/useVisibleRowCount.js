...
return React.useMemo(() => {
    // If pagination is disabled or we want to auto expand the table to whatever
    // size is necessary, we will be displaying all rows in the table.
    if (!enablePagination || enableAutoExpand || rowCount === 0) {
      return rowCount;
    }
