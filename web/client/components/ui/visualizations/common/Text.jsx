...
export default class Text extends React.PureComponent<Props, State> {
  ...
  setTextEltRef(currentElt: SVGElement | null) {
    ...
    // NOTE: Storing argument in const variable so that flow
    ...
    this.observer = new ResizeObserver(() => {
      this.animationFrameID = window.requestAnimationFrame(() => {
        // NOTE: Using the first element of the SVG node since we
  ...
  render(): React.Element<'g'> {
    ...
    // NOTE: The dx/dy values are for centering the text within the
