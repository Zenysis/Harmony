...
// TODO: move these imports to somewhere else.
...
export default class BumpChartCore extends React.PureComponent<Props, State> {
  ...
  buildGlyphColorScales(
    ...
    Object.entries(valueDomains).forEach(([dateVal, domain]) => {
      output[dateVal] = scaleLinear({ domain, range });
    });
    return output;
  }
  ...
  getSelectedLineStroke(line: LineData): Stroke | void {
    ...
    // TODO: Trigger a call to the parent to remove this value from
    // the selectedKeys.
    ...
    this.setState(prevState => {
      ...
      return {
        ...
        innerChartSize: {
          ...
          // NOTE: Using a Math.max to ensure we never render a
          // negative dimension.
