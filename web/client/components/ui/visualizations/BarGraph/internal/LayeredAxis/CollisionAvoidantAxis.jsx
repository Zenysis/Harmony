...
export default class CollisionAvoidantAxis extends React.PureComponent<Props> {
   ...
   * needed.
   * NOTE: I don't like returning row count with this method, but it
  ...
  buildTickLengths(
    ...
    return [
      tickData.map(({ textLabel, textProps, xCenter }) => {
        ...
        // NOTE: Interesting problem to try and produce the *minimum*
        ...
        // NOTE: In limited testing, it seems like the text height is
        ...
        if (!(hideOverlapping && willOverlap)) {
          ...
          // NOTE: We want to trigger a recalculation of the height of
  ...
  render(): React.Element<'g'> {
    return (
      <g ref={this._ref} className="ui-collision-avoidant-axis">
