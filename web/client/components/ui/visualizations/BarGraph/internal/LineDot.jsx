...
export default class LineDot extends React.PureComponent<Props, State> {
  ...
  maybeRenderValue(): React.Node {
    ...
    // TODO: Implement `auto` text angle calculation that works
    ...
    // TODO: update these to handle bar chart line label adjustments.
    if (metricIsNegative) {
      textProps.dy = 8;
    }
    ...
    // TODO: Sometimes, the metric value being displayed will still
