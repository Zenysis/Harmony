...
// NOTE: Need to apply padding to all sides of the inner chart
...
function PieChartDrilldown({
  ...
  >(() => {
    ...
    // NOTE: This shouldn't happen, but we don't want an invariant
  ...
  return (
    <div className={className} style={{ height, width }}>
      ...
      />
      <div ref={drilldownWrapperRef} className="pie-chart-drilldown__wrapper">
