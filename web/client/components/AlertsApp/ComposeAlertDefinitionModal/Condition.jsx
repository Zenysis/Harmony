...
const LOADING_SPINNER = (
  <Spacing flex justifyContent="center" marginTop="m">
    <LoadingSpinner />
  </Spacing>
);
...
export default function Condition({
  ...
  // NOTE: Dynamically refer to the "field" key in the check object so this can be reused
  ...
  return (
    ...
    >
      {I18N.text('Condition')}
      <RadioGroup onChange={onCheckTypeChange} value={check.type}>
