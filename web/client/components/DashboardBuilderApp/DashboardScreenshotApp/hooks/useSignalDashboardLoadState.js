// @flow
// NOTE: This file contains very specific detection logic to help aid
...
// NOTE: `document.body` will never be missing, but Flow thinks that it
...
function waitForVisualizationsToSettle(): Promise<void> {
  // NOTE: Right now, there is no extra logic, we just wait a second.
...
export default function useSignalDashboardLoadState(
  ...
  // NOTE: We only want this hook to run exactly once when the
