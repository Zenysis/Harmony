...
const BUTTON_TEXT = {
  date_filter_value_item: I18N.text('Edit Date Tile Content'),
...
export const PLACEHOLDER_ICON_MAP = {
  date_filter_value_item: 'svg-calendar',
  iframe: 'svg-iframe',
...
// NOTE: Have sizes of margin and button here in px. Feels fairly safe as
