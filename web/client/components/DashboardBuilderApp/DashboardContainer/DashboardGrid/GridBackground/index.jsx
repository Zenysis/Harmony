...
function GridBackground({
  ...
  // NOTE: To avoid passing `legacy` flags all over the place, we can
  ...
  const style = {
    ...
    // NOTE: Including `translateZ` to force GPU rendering of the
  ...
  return (
    <>
      ...
      <div ref={backgroundRef} className="gd-grid-background" style={style} />
    </>
  );
}
