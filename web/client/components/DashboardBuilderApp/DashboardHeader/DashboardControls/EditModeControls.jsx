...
import addDateFilterTileToDashboard from 'components/DashboardBuilderApp/DashboardHeader/DashboardControls/util/addDateFilterTileToDashboard';
...
function EditModeControls({
  ...
  const onAddTile = React.useCallback(
    (
      ...
      } else if (tileType === 'date_filter_value_item') {
        onDashboardChange(addDateFilterTileToDashboard(currentDashboard));
      } else {
        onDashboardChange(
