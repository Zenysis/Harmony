...
const RESERVED_KEYS = new Set(['count', 'locale', 'fallback']);
...
I18N.registerTranslations = (translations: TranslationDictionary) => {
  ...
  // Always register English translations for use as a fallback
  invariant(
    translations.en,
