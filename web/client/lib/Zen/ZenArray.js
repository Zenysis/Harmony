 ...
 *
 * NOTE: Read the comment in ZenCollections for a note on performance.
 * NOTE: Do not extend ZenArray. Type annotations are not guaranteed
...
export default class ZenArray<+T> implements Iterable<T> {
  ...
  // TODO: Sometimes the flow-parser that prettier uses will strip this
  // comment line out.
  /* ::
  ...
  */
   ...
   * one level deep.
   * TODO: this function shouldnt use reduce, it's inefficient.
   */
  flatten(): ZenArray<
    $Call<
   ...
   * TODO: remove the use of the ArrayClass argument
   */
  pull(
    funcName: string,
  ...
  */
   ...
   *
   * TODO: remove all uses of `ArrayClass` arguments from this class.
