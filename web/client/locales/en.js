...
module.exports = {
  admin_app: {
    ...
    configuration: {
      ...
      warningText: {
        ...
        cur_datasource: 'Please contact an Administrator to restart the server with the new datasource.'
      },
    ...
    AccessSelectionView: {
      ...
      AddRoleView: {
        ...
        updateMessage: 'Roles have been updated',
      },
      AddUserView: {
        addUsers: 'Add Users',
        ...
        groups: 'Groups',
        status: 'Status',
        updateMessage: 'Users have been updated',
      },
      AddDashboardView: {
        addDashboards: 'Add Dashboards',
        ...
        accessControl: 'Access Control',
        name: 'Name',
        updateMessage: 'Dashboards have been updated',
      },
      AddAlertView: {
        addAlerts: 'Add Alerts',
        ...
        duration: 'Duration',
        accessControl: 'Access Control',
        updateMessage: 'Alerts have been updated',
      }
    },
    ...
    QueryFormPanel: {
      ...
      QueryBuilder: {
        ...
        GroupByCustomizationModule: {
          dimensionAllTooltip: 'When possible, include all %(dimension)s values in the result even if they have no data. Warning: This option can cause your query to be much slower.',
          ...
          includeAll: 'Force all values to be included (slow)',
  ...
  // TODO(nina, david, moriah): $DashboardRefresh - Remove these translations
  // (and the same translations from the other locale files) when we
  // have fully switched to the new Dashboard App (which will use I18N instead)
  dashboard_builder: {
    ...
    // TODO(nina): $DashboardRefresh - Remove when we switch to new app
    EditNavbar: {
      cancel: 'Cancel',
  ...
  query_form: {
    ...
    selections: {
      ...
      pwids: {
        label: 'PWID',
        label_sub: '',
        selected_label: 'Selected PWID Indicators',
      },
      sexWorks: {
      ...
      sexWorks2019: {
        label: 'Sex Work Indicators 2019',
        label_sub: '',
        selected_label: 'Selected Sex Work Indicators 2019'
      },
      agywZa: {
        label: 'AGYW Indicators',
        label_sub: '',
          selected_label: 'Selected AGYW Indicators'
      },
      wcdoh: {
    ...
    button: {
      label: 'Analyze',
      openaqt: 'Open in New Query Tool',
    },
    date_alert: {
  ...
  select_filter: {
    labels: {
      ...
      subrecipient: 'Sub-recipient',
      agyw_age_group: 'Age group',
      form_id: 'Form ID',
      address: 'Address',
      agyw_name_of_school: 'AGYW Name of School',
      agyw_grade: 'AGYW Grade',
      agyw_higest_grade_passed: 'AGYW Highest Grade Passed',
      agyw_pipeline_cohorts: 'AGYW Cohorts',
      agyw_id: 'AGYW ID',
      agyw_uic_id: 'AGYW UIC ID',
      agyw_gender: 'Gender',
      agyw_referral_org: 'Service provider',
      agyw_full_name: 'AGYW Fullname',
      agyw_dateOfBirth: 'Date of birth',
      agyw_email: 'Email',
      agyw_phone_number: 'Phone Number',
      agyw_enrollment_date: 'Enrollment Date',
      agyw_outreach_date: 'Outreach Date',
      referral_date: 'Referral Date',
      appointment_date: 'Appointment Date',
      successful_referral_date: 'Successful Referral Date',
      agyw_last_updated: 'Information Last Updated',
      referral_org_type: 'Service Provider Referral Type',
      interventionist: 'PGT/Interventionist',
      service_plan_id: 'Service Plan ID',
      current_hiv_status: 'Current HIV status',
      hts_results: 'Rapid Test Results',
      hivss_results: 'HIVSS Test Results',
      hiv_test_frequency: 'Last HIV Test done',
      ...
      gbv_id: 'GBV ID',
      gbv_nacosa_verified: 'Nacosa verification',
      gbv_disability: 'Disability',
      gbv_trauma_containment: 'Trauma Containment',
      gbv_gender: 'Gender',
      gbv_age_group: 'Age Group',
      gbv_key_population: 'Key population',
      gbv_referred_by: 'Referred by',
      gbv_referred_to: 'Referred to',
      msm_subrecipient: 'Sub-recipient',
      msm_peer_motivator: 'Peer educator',
      msm_unique_id: 'MSM ID',
      msm_gender: 'Gender',
      msm_hiv_status: 'HIV status',
      msm_hivss_status: 'HIVSS Results',
      msm_age_group: 'Age group',
      msm_sexual_orientation: 'Sexual orientation',
      msm_referral_id: 'Referral ID',
      tg_subrecipient: 'Sub-recipient',
      tg_peer_motivator: 'Peer educator',
      tg_unique_id: 'TG ID',
      tg_gender: 'Gender',
      tg_hiv_status: 'HIV status',
      tg_hivss_status: 'HIVSS Results',
      tg_age_group: 'Age group',
      tg_referral_id: 'Referral ID',
      account: 'Account',
      acc_des: 'Account Description',
      account_type: 'Account Type',
      budget_line: 'Budget Line',
      Description: 'Activity/Budget Description',
      cost_input: 'Cost Category/Input',
      intervention: 'Intervention',
      module: 'Module',
      msp_id: 'MSP ID',
      msp_uic: 'MSP UIC ID',
      msp_gender: 'Gender',
      msp_age_group: 'Age group',
      msp_entry_point_type: 'Entry point type',
      sub_subrecipient: 'Sub-sub-recipient',
      msp_current_occupation: 'Occupation',
      pwid_id: 'PWID ID',
      pwid_name: 'PWID name',
      pwid_nacosa_verification: 'Nacosa verification',
      pwid_peer_motivator: 'Peer educator',
      pwid_gender: 'Gender',
      pwid_age_group: 'Age group',
      pwid_pu_age_group: 'PU Age group',
      pwid_sacendu_age_group: 'SACENDU Age group',
      pwid_location_type: 'Location type',
      pwid_outreach_id: 'Outreach ID',
      pwid_referral_id: 'Referral ID',
      pwid_race: 'Race',
      pwid_hiv_status: 'HIV status',
      pwid_risk_status: 'Risk status',
      idx: 'idx',
      sw_unique_id: 'Sex Worker ID',
      sw_nacosa_verification: 'Nacosa verification',
      sw_peer_motivator: 'Peer educator',
      sw_name: 'Sex Worker name',
      sw_phone_number: 'Sex Worker contact number',
      sw_gender: 'Gender',
      sw_date_of_birth: 'Sex Worker date of birth',
      sw_age: 'Sex Worker age',
      sw_age_group: 'Age group',
      sw_pu_age_group: 'PU Age group',
      sw_location_type: 'Location type',
      sw_outreach_id: 'Outreach ID',
      sw_referral_id: 'Referral ID',
      sw_race: 'Race',
      sw_hiv_status: 'HIV status',
      sw_risk_status: 'Risk status',
      ...
      // Risk scores
      h4c_diabetes_screening: 'h4c_diabetes_screening',
      num_appts: 'num_appts',
      swt_Street: 'swt_Street',
      'age_16-25': 'age_16-25',
      wks_since_last: 'wks_since_last',
      out1: 'out1',
      out1val: 'out1val',
      out2: 'out2',
      out2val: 'out2val',
      ...
      CountryName: 'Country',
      Admin1Name: 'Admin Level 1',
      Funders: 'Funder or Partner',
      RiskCauses: 'Risk Register Causes',
      CampaignStatus: 'Campaign Status',
      CommodityStockStatus: 'Commodity Stock Status',
      CommodityDeliveryStatus: 'Commodity Delivery Status',
      LLINAvailability: 'LLIN Availability',
      ProposedEndDate: 'Proposed End Date',
      CurrentEndDate: 'Current End Date',
      HBHICountry: 'HBHI Country',
      E2020Country: 'E - 2020 Country',
      E2025Country: 'E - 2025 Country',
      LLINStartDate: 'LLIN Campaign Start Date',
      IRSStartDate: 'IRS Campaign Start Date',
      GrantAgreementImplementationPeriodId: 'Grant Agreement Implementation Period Id',
      BudgetCategoryName: 'Budget Category Name',
      ActivityAreaName: 'Activity Area Name',
      GrantAgreementNumber: 'Grant Agreement Number',
      GrantAgreementStatus: 'Grant Agreement Status',
      GrantAgreementTitle: 'Grant Agreement Title',
      IsActive: 'Is Active',
      ProgramStartDate: 'Program Start Date',
      ProgramEndDate: 'Program End Date',
      ImplementationPeriodStartDate: 'Implementation Period Start Date',
      ImplementationPeriodEndDate: 'Implementation Period End Date',
      CurrentImplementationPeriod: 'Current Implementation Period',
      Cycles: 'Cycles',
      CampaignYear: 'Campaign Year',
      DistributionDate: 'Current ITN Distribution Date',
      PlanningPhase: 'Campaign Planning Phase',
      NetType: 'Net Type',
      GeographicScope: 'Campaign Geographic Scope',
      CurrencyUtilised: 'Currency Utilised',
      ResponsiblePR: 'Responsible PR',
      BaselineYear: 'Baseline Year',
      TargetYear: 'Target Year',
      CommodityTheme: 'Commodity Theme',
    ...
    agyw_referral_org: 'Service provider',
    agyw_gender: 'Gender',
    referral_org_type: 'Referral organization type',
    interventionist: 'PGT/Interventionist',
    service_plan_id: 'Service Plan ID',
    current_hiv_status: 'Current HIV status',
    hts_results: 'Rapid Test Results',
  ...
  select_granularity: {
    ...
    Client: 'Client',
    Funder: 'Funder',
    ProjectedValueRange: 'Projected Value Range',
    QualifiedLead: 'Qualified Lead',
    OpportunityType: 'Opportunity Type',
    ZenysisInvestment: 'Zenysis Investment',
    Upsell: 'Upsell',
    DateOfInitialConversations: 'Date of Initial Conversations',
    DateAwardedLost: 'Date Awarded/Lost',
    DateBooked: 'Date Booked',
    CountryRegion: 'Country/Region',
    ProvinceState: 'Province/State',
    CountyCity: 'County/City',
    PhabAuthor: 'Phab Author',
    PhabReviewer: 'Phab Reviewer',
    PhabCloser: 'Phab Closer',
    PhabTaskPriority: 'Phab Task Priority',
    PhabTaskStatus: 'Phab Task Status',
    PhabTaskAssigned: 'Phab Task Assigned',
    PhabTaskId: 'Phab Task Id',
  ...
  query_result: {
    common: {
      ...
      share_analysis: {
        ...
        // TODO(nina, david, moriah): $DashboardRefresh - Now that we are
        // rebuilding the Dashboard app, we should remove these translations
        // (and the same translations from the other locale files) and switch
        // to using I18N instead
        dashboardShare: {
          title: 'Share',
