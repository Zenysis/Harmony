...
type SerializedBarGraphSettings = {
  ...
  // NOTE: it is possible for the serialized type to have extra values
...
class BarGraphSettings
  ...
  updateUnPivotFromNewGroupBySettings(
    groupingColumns: $ReadOnlySet<string>,
  ): Zen.Model<BarGraphSettings> {
    const unPivot = groupingColumns.size === 0 ? false : this._.unPivot();
    return this._.unPivot(unPivot);
  }
