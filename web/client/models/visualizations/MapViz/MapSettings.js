...
type DefaultValues = {
  ...
  showLabels: boolean,
  tooltipBackgroundColor: {| a?: number, b: number, g: number, r: number |},
  tooltipBold: boolean,
...
type SerializedMapSettings = {|
  // 'dots' | 'tiles' | 'scaled-dots' | 'heatmap'
  adminBoundariesColor: string,
...
class MapSettings
  ...
  static defaultValues: DefaultValues = {
    ...
    showLabels: false,
    tooltipBackgroundColor: { a: 0.75, b: 255, g: 255, r: 255 },
    tooltipBold: false,
    tooltipFontColor: 'black',
    tooltipFontFamily: 'Arial',
    tooltipFontSize: '12px',
    // TODO: We shouldn't import this value into this file, but we do
  ...
  static deserialize(values: SerializedMapSettings): Zen.Model<MapSettings> {
    const { playbackSettings, ...passThroughValues } = values;
  ...
  static fromConfig(config: {
    ...
    const { fields, groupingDimension, isHeatmap, smallMode } = config;
  ...
  serialize(): SerializedMapSettings {
    return {
      ...
      autoFitToVisibleData: this._.autoFitToVisibleData(),
