...
import { TIME_GRANULARITY_MAP } from 'models/AlertsApp/AlertDefinition';
...
// TODO: Move this out of DataQualityApp to some kind of
...
// TODO: Deprecate the `id` field, it should be replaced with
...
class AlertNotification
  ...
  static derivedConfig: Zen.DerivedConfig<AlertNotification, DerivedValues> = {
    dimensionDisplayName: [
      ...
      alertNotification =>
        getFullDimensionName(alertNotification.dimensionId()),
    ],
    dimensionValue: [
  ...
  getReadableQueryInterval(
    ...
    // NOTE: The end date is stored exclusive because that's what druid uses, but for
  ...
  buildQuerySelections(
    ...
    // NOTE: For alert cases in case management, may need to override the alert definition
    // time granularity.
    ...
    return Promise.all([
      ...
      // NOTE: For alert cases in case management, a query over all time is produced and
