 ...
 *
 * NOTE: Even though all of moment's API is copied onto this class, Flow
...
// NOTE: Using `any` here since this is *very difficult* to flow type.
...
// NOTE: Only supporting a subset of momentjs's static methods for now.
export default class Moment {
  ...
  format(format?: string): string {
    // NOTE: Augment momentjs to add support for formatting values with
  ...
  /*::
  // NOTE: Expose all additional Momentjs functions to Flow with our
  // immutable Moment class substituted in.
  // TODO: Remove deprecated methods, deprecated function signatures.
...
// immutability layer.
// TODO: eventually we should remove this and only keep the methods
