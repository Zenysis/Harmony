...
class GroupingGranularity
  ...
  static deserializeAsync(
    ...
    const { granularity, includeTotal, name } = values;
    return Promise.resolve(
      GroupingGranularity.create({ granularity, includeTotal, name }),
    );
  }
  ...
  static UNSAFE_deserialize(
    ...
    const { granularity, includeTotal, name } = values;
    return GroupingGranularity.create({ granularity, includeTotal, name });
  }
  ...
  // NOTE: A unique Granularity can only be added once in the Group By
