...
// NOTE: This is not sustainable, but will work for now. Figure out how
...
class AuthorizationService {
   ...
   */
  // TODO: add type checking for the returned resources array
  @autobind
   ...
   */
  // TODO: add type checking for the returned resourceTypes array
  @autobind
  ...
  getQueryPolicies(): Promise<$ReadOnlyArray<QueryPolicy>> {
    return new Promise((resolve, reject) => {
      // NOTE: per_page necessary otherwise flask defaults to 20
      this._httpService
  ...
  createRole(role: RoleDefinition): Promise<void> {
    return new Promise((resolve, reject) => {
      this._httpService
        ...
        .then(() =>
          resolve(
            window.toastr.success(I18N.text('Role was successfully created.')),
          ),
        )
        .catch(error => {
  ...
  updateRole(role: RoleDefinition): Promise<void> {
    return new Promise((resolve, reject) => {
      this._httpService
        ...
        .then(() =>
          resolve(
            window.toastr.success(I18N.text('Role was successfully updated.')),
          ),
        )
        ...
        .then(() =>
          resolve(
            window.toastr.success(
              I18N.text('Role users were successfully updated'),
            ),
          ),
        )
        .catch(error => reject(error));
  ...
  deleteRole(role: RoleDefinition): Promise<void> {
    return new Promise((resolve, reject) => {
      this._httpService
        ...
        .then(() =>
          resolve(
            window.toastr.success(I18N.text('Role was successfully deleted.')),
          ),
        )
        .catch(error => {
          reject(error);
