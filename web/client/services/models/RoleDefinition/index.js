...
export const ROLE_TOOL_NAMES: { [string]: string } = Object.freeze({
  alertsApp: I18N.textById('Alerts'),
  analyzeTool: I18N.textById('Analyze'),
  dashboardCreator: I18N.textById('Dashboards'),
  dataQualityLab: I18N.textById('Data quality'),
});
export type RoleTools = $Keys<typeof ROLE_TOOL_NAMES>;
...
type DefaultValues = {
   ...
   * NOTE: empty string means there is no associated alertResourceRole
   */
  alertResourceRoleName: string,

  /**
   * The dashboard resource role name for this role.
   * NOTE: empty string means there is no associated dashboardResourceRole
   */
  dashboardResourceRoleName: string,
