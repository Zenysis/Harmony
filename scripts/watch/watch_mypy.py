...
def refresh_status(continuous_scroll: bool = False):
    # TODO: update mypy-check to match this
    output_lines = list(run_dmypy_command('check web/server models db', False)[1])
...
def run_dmypy(continuous_scroll: bool = False):
    ...
    # NOTE(david): By default mypy disables colored outputs when it detects that
