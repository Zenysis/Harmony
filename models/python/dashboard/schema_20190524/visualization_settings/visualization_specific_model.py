...
class AnimatedMapSettings(object):
...
@related.mutable(strict=True)
class BumpChartSettings(object):
...
@related.mutable(strict=True)
class ExpandoTreeSettings(object):
    selected_field = related.StringField('', key='selectedField')
...
@related.mutable(strict=True)
class SunburstSettings(object):
    selected_field = related.StringField('', key='selectedField')


@related.mutable(strict=True)
class TimeSeriesSettings(object):
