...
from models.python.dashboard.schema_20190124.visualization_settings import (
    SettingsGroup,
    TitleSettings,
    VisualizationType,
    ...
    def after_deserialize(self):
        ...
        for settings_object in list(self.settings.values()):
            ...
            if 'BUMP_CHART' not in view_settings:
                ...
                if series_info['seriesObjects'] == {} and correct_series_objs != {}:
                    series_info['seriesObjects'] = correct_series_objs
                if series_info['seriesOrder'] == [] and correct_series_order != []:
