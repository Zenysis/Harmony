...
from models.python.dashboard.schema_20190411.visualization_settings import (
    SettingsGroup,
    TitleSettings,
    VisualizationType,
...
def moriah(setting_objs):
    out = {}
    for (_id, settings_object) in setting_objs.items():
        # print '\n\n\n\nso',_id,settings_object
        out[_id] = VisualizationSettings(settings_object)
    return out
...
class DashboardSpecification(PythonModel):
    ...
    @settings.setter
    @DashboardProperty.setter(value_parser_function=moriah)
