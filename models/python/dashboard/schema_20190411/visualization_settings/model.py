...
from models.python.dashboard.schema_20190411.visualization_settings.visualization_specific_model import (  # pylint: disable=line-too-long
    AnimatedMapSettings,
    BarChartSettings,
    BoxPlotSettings,
    BubbleChartSettings,
...
DEFAULT_TITLE_FONT_COLOR = 'black'
...
DEFAULT_LEGEND_FONT_COLOR = 'black'
DEFAULT_LEGEND_FONT_FAMILY = 'Arial'
...
DEFAULT_XAXIS_LABEL_FONT_SIZE = '16px'
DEFAULT_XAXIS_LABEL_FONT_COLOR = 'black'
DEFAULT_XAXIS_LABEL_FONT_FAMILY = 'Arial'
DEFAULT_XAXIS_TITLE_FONT_SIZE = '18px'
DEFAULT_XAXIS_TITLE_FONT_COLOR = 'black'
DEFAULT_XAXIS_TITLE_FONT_FAMILY = 'Arial'
DEFAULT_XAXIS_GOAL_LINE = ''
DEFAULT_XAXIS_GOAL_LINE_LABEL = ''
DEFAULT_XAXIS_GOAL_LINE_FONT_SIZE = '14px'
DEFAULT_ADDITIONAL_TITLE_DISTANCE = '0px'
...
class AxesSettings(PythonModel):
    ...
    @AxisProperty.setter(value_parser_function=XAxisSettings)
    ...
    @AxisProperty.setter(value_parser_function=YAxisSettings)
