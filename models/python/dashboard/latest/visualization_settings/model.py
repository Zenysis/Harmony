...
class LegendSettings:
    ...
    consolidate_rules = related.BooleanField(True, key='consolidateRules')
...
# NOTE: Currently both AQT and GIS dashboard models make use
...
# TODO: make this naming consistent with the frontend model, which
