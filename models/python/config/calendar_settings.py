...
class GranularitySettings:
    ...
    # NOTE: Using our custom epi-week support that is available on the
    ...
    stat_month = related.ChildField(
        DateOption,
        DateOption(
            GranularityType.STAT_MONTH, 'Statistical Month', 'MMM YYYY', 'MMM'
...
class CalendarSettings:
    ...
    def create_default(
        ...
        # January.
        # NOTE: It's currently not customizable to turn on a subset of these,
        # add a parameter in the future if that becomes necessary.
        ...
        granularity_settings.fiscal_half.enabled = enable_fiscal_calendar
