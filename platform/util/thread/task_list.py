...
class TaskList:
    ...
    NOTE: If this class is useful, expand it to allow return value
    capture.
    '''
    ...
    def __exit__(self, exception_type, exception_value, exception_traceback):
        if self._pool:
            self._pool.__exit__(exception_type, exception_value, exception_traceback)
