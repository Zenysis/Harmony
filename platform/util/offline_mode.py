...
class MockSqlAlchemy:
    # NOTE: This assumes the SQLAlchemy session object will only have
    # methods called on it and not have attributes accessed.
    # TODO: Provide (or find) a more robust mocking library for
    # SQLAlchemy.
...
class MockDruidQueryClient(DruidQueryRunner):
    ...
    def run_raw_query(self, query):
        ...
        # TODO: Provide a way for the common druid queries to be mocked out
            ...
            return [
                {
                    ...
                    'result': {
                        ...
                        'maxTime': f'{today}T00:00:00.000Z',
                    },
                }
            ]
