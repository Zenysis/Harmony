...
class MapSettings:
    ...
    # TODO: We need to define an actual EntityLayerProperties type,
    # however at this point that type will likely evolve over time, so we can
    # (in the meantime) add and remove properties from this property without
    # having to build a new version
