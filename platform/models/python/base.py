            ...
            def validate_and_set_property_value(instance, value, *args, **kwargs):
                if value is None and not nullable:
                    ...
                    if value is None:
                        raise ValueError(
                            (
                                'Property \'%s\' is marked as non-nullable but a null'
                ...
                if value is not None:
                    ...
                    if validate_function:
                        try:
                            ...
                            raise ValueError(
                                (
                                    'Value \'%s\' for Property \'%s\' is invalid. '
                                    'Additional details: %s.'
                                )
...
class PythonModel(dict, metaclass=ABCMeta):
    ...
    def validate(self):
        ...
        if errors:
            raise ValueError(
                (
                    'Errors occurred during validation of type: \'{0}\' with value \'{1}\'. '
                    'Errors were: \'{2}\''
    ...
    def deserialize(self, property_dictionary, allow_extra_properties=True):
        ...
        if errors:
            raise ValueError(
                ('Errors occurred during deserialization of \'{0}\': \'{1}\'').format(
                    self, errors
                )
            )
    ...
    def serialize(self, include_null_properties=True):
        ...
        if errors:
            raise ValueError(
                ('Errors occurred during serialization of \'{0}\': \'{1}\'').format(
                    self, errors
                )
            )
