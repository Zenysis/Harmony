...
# TODO: This calculated indicator structure is in the
...
from config.harmony_demo.calculated_indicator_defs.calculated_indicator_defs import (
...
for indicator in CALCULATED_INDICATOR_GROUP_DEFINITIONS:
    ...
    if 'disaggregations' in indicator:
        for disaggregation in indicator['disaggregations']:
            ...
            full_name = f"{indicator['name']} - {disaggregation['name']}"
            _set_exports_for_indicator(
                full_id,
                full_name,
