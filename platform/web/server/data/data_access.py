...
def get_db_adapter():
    ...
    '''
    # NOTE: Lazily importing from flask so that this file can be used
    # from the pipeline.
...
class Transaction:
    ...
    def __init__(self, should_commit=None, get_session=None, read_only=False):
        ...
        read_only: boolean
            If True then nether commit or rollback is performed.
        '''
    ...
    def _default_should_commit(
        ...
        return not exception_type and not exception_value and not exception_traceback
