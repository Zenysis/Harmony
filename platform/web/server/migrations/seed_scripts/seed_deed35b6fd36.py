...
# NOTE: This class was renamed from `Permission`.
...
# NOTE: This class was renamed from `PermissionDefinition`.
...
DEFAULT_ROLE_PERMISSIONS = [
    # Dashboard Administrator
    {
        ...
        'permission_id': VIEW_RESOURCE_PERM_ID,
    },
    {
        'id': 2,
        'role_id': DASHBOARD_ADMIN_ROLE_ID,
        'permission_id': EDIT_RESOURCE_PERM_ID,
    },
    {
        'id': 3,
        'role_id': DASHBOARD_ADMIN_ROLE_ID,
        'permission_id': UPDATE_USERS_PERM_ID,
    },
    {
        'id': 4,
        'role_id': DASHBOARD_ADMIN_ROLE_ID,
        'permission_id': DELETE_RESOURCE_PERM_ID,
    },
    {
        'id': 5,
        'role_id': DASHBOARD_ADMIN_ROLE_ID,
        'permission_id': CREATE_RESOURCE_PERM_ID,
    },
    # Dashboard Editor
    {
        'id': 6,
