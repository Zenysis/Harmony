...
# NOTE: There's a name conflict with a table column named fields.
...
class AlertDefinitionResource(PrincipalResource):
    ...
    # TODO: We need to start using constants for needs and resources ugh
    @Route.POST(
        '',
        rel='create',
    ...
    # TODO: Add permission checks to default PATCH method. Currently,
    ...
    def latest_associated_notifications(self):
        ...
        NOTE: The reason fetching notifications is in the AlertDefinition
...
class AlertNotificationResource(PrincipalResource):
    ...
    class Schema:
        # NOTE: This is really referring to the authorization id, may
    ...
    def update_bulk(self, entities):
        ...
        with AuthorizedOperation('edit_resource', 'alert'):
            ...
            for entity_dict in entities:
                ...
                # NOTE: $uri gets converted to id but that isn't defined
