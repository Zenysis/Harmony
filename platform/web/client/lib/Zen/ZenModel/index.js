...
> {
   ...
   * TODO: this function is only being added for backward compatibility.
   * Once all components and models are moved to Flow, remove this function.
   * NOTE: Latest version of flow 0.100.0 has issues with returning
  ...
  // NOTE: we specify `modelValues` as a class property so that we can
