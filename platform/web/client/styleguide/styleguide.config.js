...
module.exports = {
  ...
  webpackConfig: {
    ...
    plugins: [
      ...
      // NOTE: Disable the websocket connection from starting since it
      // does not work.
      new webpack.DefinePlugin({
    ...
    // NOTE: The `publicPath` option is what broke it and it took me a
  ...
  sections: [
    ...
    },
    {
      ...
      ignore: [
        // TODO: Is there a way to share the ignore behavior?
        '**/ui/**/internal/*',
        '**/ui/**/internal/**/*',
        '**/ui/**/__tests__/*',
        '**/ui/**/__tests__/**/*',
