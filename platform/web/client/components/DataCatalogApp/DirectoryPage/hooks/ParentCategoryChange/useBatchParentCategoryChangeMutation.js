...
// NOTE: Defining input variables for the hook that are slightly
...
type InputVariables = {
  ...
  // NOTE: I couldn't figure out a clean way to share the core batch
...
export default function useBatchParentCategoryChangeMutation(): ({
  ...
  const output = React.useCallback(
    ({ optimisticUpdater, updater, variables, ...passThroughParams }) => {
      ...
      // TODO: Investigate using @deleteEdge so that we don't need to
