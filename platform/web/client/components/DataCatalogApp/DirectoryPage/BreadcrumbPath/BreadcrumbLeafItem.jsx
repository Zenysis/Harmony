...
export default function BreadcrumbLeafItem({
  ...
  // NOTE: Preferring a standalone query here because this data will
  ...
  // NOTE: We need to determine which button (left button or menu button)
  ...
  // NOTE: Special case for the root category: we do not rely on the
