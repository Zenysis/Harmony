...
export default function BreadcrumbPath({
  ...
  // NOTE: It's really annoying that a hierarchy tree needs to be built
  ...
  // can be consolidated.
  // TODO: If you register the query pieces used by the
  ...
  // NOTE: The parent needs access to the hierarchy root. Instead of
