...
export default function CategoryRow({
  ...
  const onCategoriesChange = React.useCallback(
    newCategoryMapping => {
      // NOTE: I don't actually know what happens if you call `commit` in
      // a loop. I don't have a test case right now...
      // TODO: Investigate a batch mutation instead of using a loop.
  ...
  return (
    <FieldDetailsListItem title={I18N.text('Location')}>
