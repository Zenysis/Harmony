...
// NOTE: CalculationCustomizationBlock expects these inputs. We don't
...
export default function CopyIndicatorView({
  ...
  // NOTE: This runs once on initialization when `editableCalculation`,
  ...
  if (calculation !== undefined && calculation.tag === 'FORMULA') {
    return (
