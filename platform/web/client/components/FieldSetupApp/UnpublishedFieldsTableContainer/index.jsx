...
import useHorizontalScrollbar from 'lib/hooks/useHorizontalScrollbar';
...
function UnpublishedFieldsTableContainer(): React.Element<'div'> {
  ...
  // NOTE: We have to manually keep the header scrolling inline with the
  ...
  // TODO: create a fallback component for the UnpublishedFieldTableRows
  return (
