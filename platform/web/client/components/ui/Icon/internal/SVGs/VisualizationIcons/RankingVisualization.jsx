  ...
  return (
    ...
    >
      <g fill="currentColor">
        ...
        >
          <rect height="18" rx=".2" width="18" y="46" />
          <rect height="18" rx=".2" width="18" y="24" />
          <rect height="18" rx=".2" width="18" y="2" />
          <rect height="18" rx=".2" width="18" x="44" y="25" />
          <rect height="18" rx=".2" width="18" x="44" y="46" />
          <rect height="18" rx=".2" width="18" x="44" y="2" />
        </g>
      </g>
    </svg>
  );
