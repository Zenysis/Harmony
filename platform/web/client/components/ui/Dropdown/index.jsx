...
export default class Dropdown<T> extends React.PureComponent<Props<T>> {
  static defaultProps: DefaultProps<T> = {
    ...
    emptyOptionsGroupContent: I18N.text(
      'There are no options in this group',
      'emptyGroup',
    ),
    enableSearch: false,
    ...
    menuWidth: undefined,
    noAsyncSearchContent: I18N.text(
      'Please enter a search term to see results',
      'noSearch',
    ),
    noOptionsContent: I18N.text('There are no options to select', 'noOptions'),
    ...
    searchInputPlaceholder: I18N.text('Search...', 'searchPlaceholder'),
