...
export default class MetricAxis extends React.PureComponent<Props> {
  ...
  // NOTE: We want to display a useful goal line value when a user
  ...
  // NOTE: Memoize this calculation so that we can keep hover events
  ...
  @autobind
  onHoverEnd() {
    // NOTE: Performance hack. Reset the memoization of the hover
  ...
  render(): React.Element<'g'> | null {
    ...
    // NOTE: Need to render the goal line tags and paths separately
