...
export default function usePagination(
  ...
  // NOTE: This hook must mutate its state in a *synchronous* way and
  ...
  // NOTE: Since we aren't using a `useState`, when the user manually
  ...
  React.useMemo(() => {
    ...
    const bodyHeight = calculateTableBodyHeight(
      tableHeight, headerHeight, showFooter);
