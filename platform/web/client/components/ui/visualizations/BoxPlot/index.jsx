...
class BoxPlotCore extends React.PureComponent<Props, State> {
  ...
  buildLeftAxisTextProps(theme: BoxPlotTheme): AxisTextProps {
    ...
    // TODO: A lot of these properties are repeated in several
  ...
  // TODO: Generalize the LayeredAxis a bit more so that non-BarGraph
  ...
  maybeRenderOutlierTooltip(): React.Node {
    ...
    // TODO: Currently all uses of the box plot use a custom tooltip.
    ...
    const { dataPoint, dimensionValue, left, top } = outlierTooltipData;
  ...
  renderLeftAxis(): React.Element<typeof AxisLeft> {
    const { metricValueFormatter, theme, yAxisLabel } = this.props;
    return (
      <AxisLeft
        label={yAxisLabel}
        left={10}
