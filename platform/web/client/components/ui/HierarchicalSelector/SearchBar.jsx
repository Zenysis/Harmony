 ...
 *
 * NOTE: it may be tempting to make this into a controlled
...
> {
  ...
  getSearchPlaceHolder(): string {
    if (this.props.searchPath.size() > 1) {
      return I18N.text('Search for data elements in this category');
    }
    return I18N.text('Search for data elements');
  }
