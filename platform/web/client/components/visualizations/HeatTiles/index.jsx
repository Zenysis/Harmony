...
// TODO: Remove this when SQT querying style is removed.
const DEFAULT_DATE_QUERY_RESULT_GROUPING = QueryResultGrouping.create({
  // NOTE: HeatTiles in SQT defaults to Month.
...
class HeatTiles extends React.PureComponent<Props, State> {
  ...
  getGraphData() {
    ...
    // NOTE: $HeatTilesRefactor - This section (including the first if
    ...
    if (showTimeOnYAxis) {
      // NOTE: HeatTiles will request data in the exact date
      ...
      // the proper format.
      // TODO: Remove dependence on timeSeriesUtil or refactor it.
      ...
      // TODO: $HeatTilesRefactor - Don't mimic functionality, put this
      // in the right place
      const buckets = {};
      dates.forEach(date => {
      ...
      series.forEach(loc => {
        ...
        // TODO: I don't like this way of creating bucketedValues, but
      ...
      firstYaxisSelections.forEach(fieldId => {
        // TODO: Remove this condition when controls are synced with
