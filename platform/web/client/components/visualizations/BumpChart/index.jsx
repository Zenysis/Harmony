...
export default class BumpChart extends React.PureComponent<Props, State> {
  ...
  // NOTE: I want to use a Zen.Map for storage of selectedKeys, but
  ...
  // NOTE: Workaround limitation in how view specific settings are
  ...
  getValueFormatter(): ValueFormatter {
    ...
    // NOTE: This is a really bad bandaid fix. Currently there is a bug
  ...
  // TODO: What happens if the number of available colors changes?
  @autobind
  onLineSelected(key: string) {
    this.setState(({ selectedKeys }) => {
      ...
      // NOTE: Keeping selectedKeys in sync for the controls prop and
  ...
  maybeRenderBumpChart(height: number, width: number): React.Node {
    ...
    // TODO: There is a type confusion inside flow that is happening
