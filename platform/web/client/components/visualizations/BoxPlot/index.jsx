...
function getSelectableDimensions(
  ...
  // NOTE: I HATE THIS STUPID NATION GROUPING FROM EXISTING. IT BREAKS
  // THINGS AND DEFIES LOGIC.
...
export default class BoxPlot extends React.PureComponent<Props> {
  ...
  // NOTE: We do not currently have an `updateFromNewGroupBySettings`
  ...
  // TODO: Implement the `updateFromNewGroupBySettings`
