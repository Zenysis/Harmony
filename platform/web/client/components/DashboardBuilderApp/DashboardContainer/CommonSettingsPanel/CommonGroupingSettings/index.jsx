...
type Props = {
  ...
  >,
  horizontal: boolean,
  onSettingsChange: (GroupingSettings<GroupingItem>) => void,
  presenting: boolean,
  settings: GroupingSettings<GroupingItem>,
};
...
function CommonGroupingSettings({
  ...
  // NOTE: The existing DashboardGroupBySelector expects values to come
