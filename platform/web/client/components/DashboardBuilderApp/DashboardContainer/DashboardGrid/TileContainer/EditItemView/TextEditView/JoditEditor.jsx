// @flow
// NOTE: This is a copy of the JoditEditor component from the
...
// NOTE: Stubbing out type here based on what is used.
...
const JoditEditor = React.forwardRef(
  (
    { config, editorRef, id, name, onBlur, onChange, tabIndex, value }: Props,
    ...
    // NOTE: The hooks in this component are very badly written in
