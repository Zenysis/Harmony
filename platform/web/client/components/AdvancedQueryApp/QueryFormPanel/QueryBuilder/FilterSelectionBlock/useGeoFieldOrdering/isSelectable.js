...
function _buildGeoItemFilterMap(
  ...
  // NOTE: We know that geo dimensions use the AndFilter to represent
  // the hierarchical dimensions for a given value
  if (filter.tag !== 'AND') {
    return filterMap;
  }

  // NOTE: We know that geo dimension values are type SelectorFilter
...
export default function isSelectable(
  ...
  // NOTE: Edge case: This value has already been selected for the
