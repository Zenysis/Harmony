...
class NumberReportsTimeSeries extends React.PureComponent<Props, State> {
  ...
  buildChartData(
    ...
    return lines.map(line => {
      ...
      return { data, dimensions, name: key };
    });
  }
  ...
  loadTimeSeriesData(): void {
    ...
    this.setState({ loading: true }, () => {
      ...
      this._timeSeriesDataPromise = DataQualityService.getNumReportsTimeSeries(
        field,
        groupingDimension,
        filters,
  ...
  renderLimitResultsDropdown(): React.Node {
    ...
    return (
      ...
      >
        <Dropdown onSelectionChange={this.onNumLinesChange} value={numLines}>
          {options}
        </Dropdown>
      </LabelWrapper>
    );
