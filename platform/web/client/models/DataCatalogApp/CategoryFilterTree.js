...
export default class CategoryFilterTree {
  ...
  linkParentCategories(
    ...
    parentIds.forEach(parentId => {
      ...
      // been created.
      // NOTE: This assumes that the relationships defined in the
  ...
  getCategoryPath(
    ...
    const buildPath = (id: string) => {
      ...
      // NOTE: Categories can only have one parent.
  ...
  finalize(): HierarchyItem<CategoryFilterItem> {
    ...
    // NOTE: The `HierarchyItem` model has a very restricted definition
