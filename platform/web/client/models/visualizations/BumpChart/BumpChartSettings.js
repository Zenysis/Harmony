...
type DefaultValues = {
  resultLimit: number,
  selectedKeys: { [string]: number, ... }, // TODO: Should be ZenMap eventually.
  sortOrder: string,
  theme: string,
...
class BumpChartSettings
  ...
  static defaultValues: DefaultValues = {
    ...
    // TODO: This control is set directly based on user interaction
    ...
    // TODO: Support ZenMaps in dashboard serialization of
