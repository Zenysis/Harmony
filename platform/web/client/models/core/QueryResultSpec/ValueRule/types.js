...
import type EqualToValueRule from 'models/core/QueryResultSpec/ValueRule/EqualToValueRule';
...
import type NotANumberRule from 'models/core/QueryResultSpec/ValueRule/NotANumberRule';
...
export type SerializedValueRule =
  ...
  | Zen.Serialized<EqualToValueRule>
