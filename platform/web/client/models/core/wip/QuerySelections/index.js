...
type RequiredValues = {
  ...
  // NOTE: When complex filtering is added,
...
class QuerySelections
  ...
  buildQueryFilter(): QueryFilter | void {
    ...
    // NOTE: Some QueryFilterItems can produce an empty filter
    ...
    // NOTE: Right now we are only supporting a single AND filter around
  ...
  isQueryEqual(otherQuery: Zen.Model<QuerySelections>): boolean {
    ...
    // NOTE: Instead of checking each filter directly, we require the
