...
type DefaultValues = {
  // TODO: eventually this should be stored as part of the Calculation,
  // not in the Field
...
export function getOriginalId(id: string): string {
  // NOTE: Data Quality Lab requires non-customized id. Adding this to
...
class Field
  ...
  addFilterItem(
    ...
    if (!this._.customizableFilterItems().isEmpty()) {
      // TODO: remove this once we support more filter items
