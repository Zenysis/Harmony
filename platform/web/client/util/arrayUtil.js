 ...
 * the end.
 *
 * NOTE: the order of `null` and `undefined` is not deterministic
...
export function sortNullOrUndefined(
  ...
  // NOTE: intentionally using == instead of === to simplify the
...
export function sortNumeric(
  ...
  // TODO: Find out if we can switch this to Number.isFinite
