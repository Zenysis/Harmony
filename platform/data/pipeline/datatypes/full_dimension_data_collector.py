...
class FullRowDimensionDataCollector:
    ...
    def collect_hierarchical_canonical_dimensions(self, row, attach_meta=True):
        ...
        if attach_meta:
            # NOTE: using get here since match failures mean no metadata
            row_data.update(
    ...
    def collect_non_hierarchical_canonical_dimensions(self, row):
        ...
        NOTE: unlike for hierarchical dimensions, metadata is not yet collected
        '''
    ...
    def collect_metadata(self, input_row):
        ...
        TODO: add metadata collection for non-hierarchical dimensions
        '''
        ...
        for metadata_key, val in metadata.items():
            ...
            ), f'Attempting to overwrite data for {metadata_key} for key {row_key}'
