...
from config.harmony_demo.aggregation import (
    DIMENSIONS,
    DIMENSION_ID_MAP,
    GEO_TO_LATLNG_FIELD,
)
from config.harmony_demo.datatypes import BaseRowType
from config.harmony_demo.filters import EXCLUDE_FILTER_DIMENSIONS
...
DRUID_HOST = settings.DRUID_HOST

# A set of druid datasources that should not be deleted when cleaning datasources.
DRUID_DATASOURCES_TO_PRESERVE = set()
